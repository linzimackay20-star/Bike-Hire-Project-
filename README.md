...
## Issues faced:
-	There are a substantial amount of blanks in the station columns.
-	No personal data was provided so I cannot analyse how many rides each individual customer takes each week/month etc. 
...
## Recommendations:  
•	Promote membership more heavily in the top 3 stations used by riders : 
o	Kingsbury St & Kinzie St   
o	Navy Pier 
o	DuSable Lake Shore Dr & Monroe St.
...
## Future steps: 
•	It would be useful to have more data on costings and individual rider data. Would be useful to see if some casual riders are spending more a year than the membership fee. If so the promotional campaign could be more specific eg. Casual users could save £100 a year by joining the members scheme. If contact data was held for these customers they could also be contacted directly with promotional material. 
